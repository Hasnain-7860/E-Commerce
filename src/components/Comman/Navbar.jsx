...
const Navbar = () => {
    ...
    const [navDrawerOpen, setNavDarwerOpen] = useState(false);

    const toggleNavDrawer = () =>{
      setNavDarwerOpen(!navDrawerOpen)
    }
      ...
      <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
        ...
        <div className='flex items-center space-x-4'>
            ...
            <button onClick={toggleCartDrawer} className='relative hover:text-black'>
                <AiOutlineShopping className='h-6 w-6 text-gray-700' />
        ...
        <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transitio-transform duration-300 z-50 ${navDrawerOpen ? "translate-x-0": "-translate-x-full"}`}>
