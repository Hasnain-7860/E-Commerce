  ...
  <footer className='border-t py-12 '>
    <div className='container mx-auto grid grid-col-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
      <div>
        ...
        <p className='text-gray-500 mb-4'>
          Be the first to hear  abour new products, exclusive event, and online offers.
        </p>
      ...
      <div>
        ...
        <ul className='space-y-2 text-gray-600'>
          <li>
            <Link to="#" className='hover:text-gray-500 transition-colors'>Mens's Top Wear</Link>
          </li>
           <li>
            <Link to="#" className='hover:text-gray-500 transition-colors'>Women's Top Wear</Link>
          </li>
           <li>
            <Link to="#" className='hover:text-gray-500 transition-colors'>Mens's Bottom Wear</Link>
          </li>
           <li>
    ...
    <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
      <p className='text-gray-500 text-sm tracking-tighter text-center'>
        2025, Hasnain. All Right Reserved.
      </p>
    </div>
  </footer>
  )
